...
namespace assembler
{
    ...
    Register Processor::intArg64(unsigned char number, unsigned char arg)
    {
        switch(arg)
        {
            case 0: return Register(*this, ECX);
            case 1: return Register(*this, EDX);
            case 2: return Register(*this, R8);
            case 3: return Register(*this, R9);
    ...
    CodePage::CodePage(unsigned int Size, void* requestedStart) : used(0), final(false), references(1)
    {
        ...
        if((size_t)Size > pageStep) pageStep = (size_t)Size;
