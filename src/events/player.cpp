...
REGISTER_EVENT_HANDLER(alt::CEvent::Type::PLAYER_DEATH,
                       PlayerDeath,
                       "void",
...
REGISTER_EVENT_HANDLER(alt::CEvent::Type::PLAYER_WEAPON_CHANGE,
                       PlayerWeaponChange,
                       "void",
...
REGISTER_EVENT_HANDLER(alt::CEvent::Type::WEAPON_DAMAGE_EVENT,
                       WeaponDamage,
                       "void",
...
REGISTER_EVENT_HANDLER(alt::CEvent::Type::PLAYER_ENTERING_VEHICLE,
