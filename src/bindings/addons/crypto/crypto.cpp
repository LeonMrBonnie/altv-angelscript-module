...
// todo: fix this lol
    ...
    REGISTER_GLOBAL_FUNC(
      "string Hash(crypto::HashAlgorithm algorithm, const string&in input)", GetNamedHash, "Hashes a string using the specified hash algorithm");
    ...
    REGISTER_GLOBAL_FUNC("string Encrypt(crypto::EncryptAlgorithm encryptAlgorithm, const string&in input, const string&in salt, uint rounds = 1024)",
                         GetNamedEncryption,
