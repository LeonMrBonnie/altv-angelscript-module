...
static ModuleExtension playerExtension("alt", [](asIScriptEngine* engine, DocsGenerator* docs) {
    ...
    REGISTER_PROPERTY_WRAPPER_SET(
      "Player", "uint", "model", (Helpers::GenericWrapper<alt::IPlayer, alt::IPlayer, &alt::IPlayer::SetModel, void, uint32_t>));
#endif

    REGISTER_PROPERTY_WRAPPER_GET(
      "Player", "uint", "health", (Helpers::GenericWrapper<alt::IPlayer, alt::IPlayer, &alt::IPlayer::GetHealth, uint32_t>));
#ifdef SERVER_MODULE
    REGISTER_PROPERTY_WRAPPER_SET(
      "Player", "uint", "health", (Helpers::GenericWrapper<alt::IPlayer, alt::IPlayer, &alt::IPlayer::SetHealth, void, uint32_t>));
#endif
    REGISTER_PROPERTY_WRAPPER_GET(
      "Player", "uint", "maxHealth", (Helpers::GenericWrapper<alt::IPlayer, alt::IPlayer, &alt::IPlayer::GetMaxHealth, uint32_t>));
#ifdef SERVER_MODULE
    REGISTER_PROPERTY_WRAPPER_SET(
      "Player", "uint", "maxHealth", (Helpers::GenericWrapper<alt::IPlayer, alt::IPlayer, &alt::IPlayer::SetMaxHealth, void, uint32_t>));
#endif

    REGISTER_PROPERTY_WRAPPER_GET(
      "Player", "uint", "armour", (Helpers::GenericWrapper<alt::IPlayer, alt::IPlayer, &alt::IPlayer::GetArmour, uint32_t>));
#ifdef SERVER_MODULE
    REGISTER_PROPERTY_WRAPPER_SET(
      "Player", "uint", "armour", (Helpers::GenericWrapper<alt::IPlayer, alt::IPlayer, &alt::IPlayer::SetArmour, void, uint32_t>));
#endif
    REGISTER_PROPERTY_WRAPPER_GET(
      "Player", "uint", "maxArmour", (Helpers::GenericWrapper<alt::IPlayer, alt::IPlayer, &alt::IPlayer::GetMaxArmour, uint32_t>));
#ifdef SERVER_MODULE
    REGISTER_PROPERTY_WRAPPER_SET(
      "Player", "uint", "maxArmour", (Helpers::GenericWrapper<alt::IPlayer, alt::IPlayer, &alt::IPlayer::SetMaxArmour, void, uint32_t>));
#endif

    REGISTER_PROPERTY_WRAPPER_GET(
      "Player", "uint", "weapon", (Helpers::GenericWrapper<alt::IPlayer, alt::IPlayer, &alt::IPlayer::GetCurrentWeapon, uint32_t>));
#ifdef SERVER_MODULE
    REGISTER_PROPERTY_WRAPPER_SET(
      "Player", "uint", "weapon", (Helpers::GenericWrapper<alt::IPlayer, alt::IPlayer, &alt::IPlayer::SetCurrentWeapon, void, uint32_t>));
#endif
    REGISTER_PROPERTY_WRAPPER_GET("Player", "array<uint>@", "weaponComponents", GetWeaponComponents);
    REGISTER_PROPERTY_WRAPPER_GET(
      "Player", "uint8", "weaponTint", (Helpers::GenericWrapper<alt::IPlayer, alt::IPlayer, &alt::IPlayer::GetCurrentWeaponTintIndex, uint8_t>));
    ...
    REGISTER_PROPERTY_WRAPPER_GET(
      "Player", "bool", "inRagdoll", (Helpers::GenericWrapper<alt::IPlayer, alt::IPlayer, &alt::IPlayer::IsInRagdoll, bool>));
    ...
    REGISTER_PROPERTY_WRAPPER_GET(
      "Player", "bool", "shooting", (Helpers::GenericWrapper<alt::IPlayer, alt::IPlayer, &alt::IPlayer::IsShooting, bool>));
    REGISTER_PROPERTY_WRAPPER_GET(
      "Player", "bool", "reloading", (Helpers::GenericWrapper<alt::IPlayer, alt::IPlayer, &alt::IPlayer::IsReloading, bool>));
#ifdef SERVER_MODULE
    REGISTER_PROPERTY_WRAPPER_GET(
      "Player", "bool", "connected", (Helpers::GenericWrapper<alt::IPlayer, alt::IPlayer, &alt::IPlayer::IsConnected, bool>));
#endif

    REGISTER_PROPERTY_WRAPPER_GET(
      "Player", "float", "moveSpeed", (Helpers::GenericWrapper<alt::IPlayer, alt::IPlayer, &alt::IPlayer::GetMoveSpeed, float>));
    ...
    REGISTER_PROPERTY_WRAPPER_GET(
      "Player", "bool", "inVehicle", (Helpers::GenericWrapper<alt::IPlayer, alt::IPlayer, &alt::IPlayer::IsInVehicle, bool>));
    ...
    REGISTER_PROPERTY_WRAPPER_GET(
      "Player", "bool", "flashlightActive", (Helpers::GenericWrapper<alt::IPlayer, alt::IPlayer, &alt::IPlayer::IsFlashlightActive, bool>));
    ...
    REGISTER_PROPERTY_WRAPPER_GET(
      "Player", "uint64", "socialId", (Helpers::GenericWrapper<alt::IPlayer, alt::IPlayer, &alt::IPlayer::GetSocialID, uint64_t>));
    REGISTER_PROPERTY_WRAPPER_GET(
      "Player", "uint64", "hwid", (Helpers::GenericWrapper<alt::IPlayer, alt::IPlayer, &alt::IPlayer::GetHwidHash, uint64_t>));
    REGISTER_PROPERTY_WRAPPER_GET(
      "Player", "uint64", "hwidEx", (Helpers::GenericWrapper<alt::IPlayer, alt::IPlayer, &alt::IPlayer::GetHwidExHash, uint64_t>));
    ...
    REGISTER_METHOD_WRAPPER(
      "Player", "bool RemoveWeapon(uint weapon)", (Helpers::GenericWrapper<alt::IPlayer, alt::IPlayer, &alt::IPlayer::RemoveWeapon, bool, uint32_t>));
    REGISTER_METHOD_WRAPPER(
      "Player", "void RemoveAllWeapons()", (Helpers::GenericWrapper<alt::IPlayer, alt::IPlayer, &alt::IPlayer::RemoveAllWeapons>));
#endif

#ifdef SERVER_MODULE
    REGISTER_METHOD_WRAPPER(
      "Player", "void ClearBloodDamage()", (Helpers::GenericWrapper<alt::IPlayer, alt::IPlayer, &alt::IPlayer::ClearBloodDamage>));
    REGISTER_METHOD_WRAPPER(
      "Player",
    ...
    REGISTER_METHOD_WRAPPER(
      "Player", "void SetWeather(uint8 weather)", (Helpers::GenericWrapper<alt::IPlayer, alt::IPlayer, &alt::IPlayer::SetWeather, void, uint8_t>));
    REGISTER_METHOD_WRAPPER("Player",
                            "void Kick(const string&in reason = \"Kicked\")",
                            (Helpers::GenericWrapper<alt::IPlayer, alt::IPlayer, &alt::IPlayer::Kick, void, const std::string&>));
    REGISTER_METHOD_WRAPPER("Player",
    ...
    REGISTER_METHOD_WRAPPER(
      "Player", "Prop GetProps(uint8 component)", (Helpers::GenericWrapper<alt::IPlayer, alt::IPlayer, &alt::IPlayer::GetProps, alt::Prop, uint8_t>));
    REGISTER_METHOD_WRAPPER("Player",
