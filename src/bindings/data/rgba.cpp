...
static DataExtension rgbaExtension([](asIScriptEngine* engine, DocsGenerator* docs) {
    ...
    REGISTER_PROPERTY("RGBA", "const uint8 r", alt::RGBA, r);
    REGISTER_PROPERTY("RGBA", "const uint8 g", alt::RGBA, g);
    REGISTER_PROPERTY("RGBA", "const uint8 b", alt::RGBA, b);
    REGISTER_PROPERTY("RGBA", "const uint8 a", alt::RGBA, a);
