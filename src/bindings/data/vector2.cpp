...
static DataExtension vector2Extension([](asIScriptEngine* engine, DocsGenerator* docs) {
    ...
    REGISTER_PROPERTY("Vector2", "const float x", Vector2, x);
    REGISTER_PROPERTY("Vector2", "const float y", Vector2, y);
    ...
    REGISTER_METHOD("Vector2", "Vector2 ToRadians()", Vector2, ToRadians);
    REGISTER_METHOD("Vector2", "Vector2 ToDegrees()", Vector2, ToDegrees);
